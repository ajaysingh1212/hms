...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ipdAdmission.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ipd-admissions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('admission_time') ? 'is-invalid' : '' }}" type="text" name="admission_time" id="admission_time" value="{{ old('admission_time') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bed') ? 'is-invalid' : '' }}" name="bed_id" id="bed_id">
                    @foreach($beds as $id => $entry)
                        <option value="{{ $id }}" {{ old('bed_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('bed'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('condition_on_admission') ? 'is-invalid' : '' }}" type="text" name="condition_on_admission" id="condition_on_admission" value="{{ old('condition_on_admission', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipd_number') ? 'is-invalid' : '' }}" type="text" name="ipd_number" id="ipd_number" value="{{ old('ipd_number', '') }}">
