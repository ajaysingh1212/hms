...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ipdDischargeSummary.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ipd-discharge-summaries.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('condition_on_discharge') ? 'is-invalid' : '' }}" type="text" name="condition_on_discharge" id="condition_on_discharge" value="{{ old('condition_on_discharge', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('advice') ? 'is-invalid' : '' }}" name="advice" id="advice">{!! old('advice') !!}</textarea>
