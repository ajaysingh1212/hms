...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.opdVisit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.opd-visits.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('visit_date') ? 'is-invalid' : '' }}" type="text" name="visit_date" id="visit_date" value="{{ old('visit_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('visit_time') ? 'is-invalid' : '' }}" type="text" name="visit_time" id="visit_time" value="{{ old('visit_time') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('symptoms') ? 'is-invalid' : '' }}" name="symptoms" id="symptoms">{!! old('symptoms') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('visit_type') ? 'is-invalid' : '' }}" name="visit_type" id="visit_type">
                    ...
                    @foreach(App\Models\OpdVisit::VISIT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('visit_type', 'new') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
