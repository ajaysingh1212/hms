...
<div class="card custom-card">
    <div class="card-header bg-primary text-white card-header-compact">
        <strong>{{ trans('global.create') }} {{ trans('cruds.ipdVital.title_singular') }}</strong>
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route('admin.ipd-vitals.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mt-3">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input class="form-control {{ $errors->has('pulse') ? 'is-invalid' : '' }}" type="text" name="pulse" id="pulse" value="{{ old('pulse', '') }}">
                    @if($errors->has('pulse'))
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input class="form-control {{ $errors->has('spo_2') ? 'is-invalid' : '' }}" type="text" name="spo_2" id="spo_2" value="{{ old('spo_2', '') }}">
                    @if($errors->has('spo_2'))
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input class="form-control {{ $errors->has('respiration') ? 'is-invalid' : '' }}" type="text" name="respiration" id="respiration" value="{{ old('respiration', '') }}">
